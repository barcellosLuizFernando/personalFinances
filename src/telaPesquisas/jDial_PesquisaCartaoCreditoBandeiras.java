 ...
 * @author ferna
 */
public class jDial_PesquisaCartaoCreditoBandeiras extends javax.swing.JDialog {

    public static JInternalFrame pai;
    private CartaoCredito_BandeirasDAO ccbDAO;

    /**
     * Creates new form NewJDialog
     */
    public jDial_PesquisaCartaoCreditoBandeiras(JInternalFrame parent, boolean modal) {
        this.pai = parent;
        this.setModal(modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jDial_PesquisaCartaoCreditoBandeiras.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                jDial_PesquisaCartaoCreditoBandeiras dialog = new jDial_PesquisaCartaoCreditoBandeiras(pai, true);
    ...
    private void incluiPesquisa() {
        ccbDAO = new CartaoCredito_BandeirasDAO();
        DefaultTableModel lista = (DefaultTableModel) jTable1.getModel();

        for (CartaoCreditoBandeiras m : ccbDAO.getCartaoCreditoBandeiras()) {
    ...
    private void enviaResultado() {
        ...
        for (CartaoCreditoBandeiras m : ccbDAO.al_ccB) {
            if (m.getId() == id) {
                /**
