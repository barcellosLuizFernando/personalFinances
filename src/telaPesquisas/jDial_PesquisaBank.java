 ...
 * @author ferna
 */
public class jDial_PesquisaBank extends javax.swing.JDialog {
     ...
     */
    public jDial_PesquisaBank(JInternalFrame parent, boolean modal) {
        this.pai = parent;
        this.setModal(modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Pesquisa Instituição Financeira");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jDial_PesquisaBank.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                jDial_PesquisaBank dialog = new jDial_PesquisaBank(pai, true);
