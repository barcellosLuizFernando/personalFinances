 ...
 * @author ferna
 */
public class jDial_PesquisaMunicipio extends javax.swing.JDialog {
     ...
     */
    public jDial_PesquisaMunicipio(JInternalFrame parent, boolean modal) {
        this.pai = parent;
        this.setModal(modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jDial_PesquisaMunicipio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                jDial_PesquisaMunicipio dialog = new jDial_PesquisaMunicipio(pai, true);
    ...
    private void incluiPesquisa() {
        ...
        for (CadMunic m : municipiosDAO.getMunicipio()) {
    ...
    private void enviaResultado() {
        ...
        for (CadMunic m : municipiosDAO.al_Munic) {
            if (m.getId() == id) {
                /**
                 * VERIFICA QUEM CHAMOU
                 */
                if (pai instanceof IntFrm_CadPessoas) {
                    IntFrm_CadPessoas frm = (IntFrm_CadPessoas) pai;
                    frm.recebeMunicipio(m);
