 ...
 * @author ferna
 */
public class jDial_PesquisaLancamentoTipo extends javax.swing.JDialog {
    ...
    private LancamentosTipoDAO lancamentosTipoDAO;

    /**
     * Creates new form NewJDialog
     */
    public jDial_PesquisaLancamentoTipo(JInternalFrame parent, boolean modal) {
        this.pai = parent;
        this.setModal(modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Código", "Nome", "Antecipa", "Obrigatório"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jDial_PesquisaLancamentoTipo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                jDial_PesquisaLancamentoTipo dialog = new jDial_PesquisaLancamentoTipo(pai, true);
    ...
    private void incluiPesquisa() {
        lancamentosTipoDAO = new LancamentosTipoDAO();
        DefaultTableModel lista = (DefaultTableModel) jTable1.getModel();

        for (LancamentosTipo m : lancamentosTipoDAO.getLancamentosTipo()) {
    ...
    private void enviaResultado() {
        ...
        for (LancamentosTipo m : lancamentosTipoDAO.al_LancamentosTipo) {
            if (m.getId() == id) {
                /**
